...
# Moon-Earth distance terms — Meeus Ch.47 Table 47.A (Σr, units: 0.001 km)
# Built once at file scope; moon_position() is on the hot path.
my @DR_TERMS = (
...
sub sun_position {
    ...
    my $mS = 149597870 * (1 + 0.000140 - 0.016708 * cos($lS) - 0.000140 * cos(2 * $lS));
...
sub equatorial_to_geographic {
    ...
    # $delta is already geodetic (the caller converts on the ellipsoid),
    # so no flattening correction is applied here.
